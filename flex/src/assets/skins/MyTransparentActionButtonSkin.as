 ...
 */
public class MyTransparentActionButtonSkin extends ActionBarButtonSkinBase {
    //--------------------------------------------------------------------------
    //
    //  Constructor
    //
     ...
     *  @productversion Flex 4.5
     */
    public function MyTransparentActionButtonSkin() {
        super();
        upBorderSkin = MyTransparentActionButton_up;
        downBorderSkin = MyTransparentActionButton_down;
